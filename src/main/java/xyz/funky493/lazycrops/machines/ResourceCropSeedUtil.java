 ...
 */
public final class ResourceCropSeedUtil {

    private ResourceCropSeedUtil() {
    }
     ...
     */
    public static boolean isResourceCropSeed(ItemStack stack) {
    ...
    public static Item essenceFor(ItemStack stack) {
        ...
        return crop == null ? null : SeedEssenceItems.getItemFromCropLevel(crop.getLevel());
    }
}
